...
namespace DicomServerTest.Worklist.Model
{
    class WorklistHandler
    {
        ...
        private static IQueryable<WorklistItem> AddNameCondition(IQueryable<WorklistItem> exams, string dicomName)
        {
            if (string.IsNullOrEmpty(dicomName) || dicomName == "*") return exams;
        ...
        private static IQueryable<WorklistItem> AddDateCondition(IQueryable<WorklistItem> exams, string dateCondition)
        {
