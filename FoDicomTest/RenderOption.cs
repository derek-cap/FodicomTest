...
namespace FoDicomTest
{
    class RenderOption
    {
        ...
        private RenderOption(BitDepth bits)
        {
            BitDepth = bits;
            Invert = false;
        }
        ...
        public static RenderOption FromDataset(DicomDataset dataset)
        {
        ...
        public static RenderOption FromWindowLevel(DicomDataset dataset)
        {
            ...
            var options = new RenderOption(bits)
            {
        ...
        public static RenderOption FromImagePixelValueTags(DicomDataset dataset)
        {
        ...
        public static RenderOption FromMinMax(DicomDataset dataset)
        {
            var bits = BitDepth.FromDataset(dataset);
            var options = new RenderOption(bits)
            {
        ...
        public static RenderOption FromBitRange(DicomDataset dataset)
        {
            var bits = BitDepth.FromDataset(dataset);
            var options = new RenderOption(bits)
            {
        ...
        public static RenderOption FromHistogram(DicomDataset dataset, int percent = 90)
        {
            var bits = BitDepth.FromDataset(dataset);
            var options = new RenderOption(bits)
            {
